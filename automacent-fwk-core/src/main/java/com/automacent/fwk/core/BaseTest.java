...
public abstract class BaseTest {
	...
	/**
	 * Add test parameter with in scope of current method. If the parameter with key already exists, the value is
	 * overwritten
	 * 
	 * @param key   Name of the parameter
	 * @param value Value of the parameter
	...
	protected void addLocalTestParameter(String key, String value) {
		addTestParameter(String.format("automacent.parameter.local.%s",key),value);
	}
